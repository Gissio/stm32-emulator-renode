...
namespace Antmicro.Renode.Peripherals.GPIOPort
{
    ...
    public class STM32F1_GPIO : BaseGPIOPort, IDoubleWordPeripheral, ILocalGPIOReceiver
    {
        ...
        public STM32F1_GPIO(IMachine machine, List<List<int>> invertedAFPins = null) : base(machine, NumberOfPorts)
        {
        ...
        {
            public GPIOAlternateFunction(STM32F1_GPIO port, int pin)
            {
                this.port = port;
                this.pin = pin;
            ...
            private readonly STM32F1_GPIO port;
