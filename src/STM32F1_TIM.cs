...
// Mods by Gissio (C)-2025:
// * Added trigger output support (for triggering ADCs).
//  - GPIO line 0: TRGO
//  - GPIO line 1: CH1
//  - GPIO line 2: CH2
//  - GPIO line 3: CH3
...
namespace Antmicro.Renode.Peripherals.Timers
{
    ...
    public class STM32F1_TIM : LimitTimer, IDoubleWordPeripheral, IKnownSize, INumberedGPIOOutput, IPeripheralRegister<IGPIOReceiver, NumberRegistrationPoint<int>>, IPeripheralRegister<IGPIOReceiver, NullRegistrationPoint>, IGPIOSender
    {
        public STM32F1_TIM(IMachine machine, long frequency, uint initialLimit) : base(machine.ClockSource, frequency, limit: initialLimit, direction: Direction.Ascending, enabled: false, autoUpdate: false)
        {
            this.machine = machine;
            sysbus = machine.GetSystemBus(this);
            IRQ = new GPIO();
            TriggerOutput0 = new GPIO();
            TriggerOutput1 = new GPIO();
            TriggerOutput2 = new GPIO();
            TriggerOutput3 = new GPIO();
            TriggerOutput4 = new GPIO();
            ...
            for (var i = 0; i < NumberOfCCChannels; ++i)
            {
                ...
                ccTimers[j].LimitReached += delegate
                {
                    ...
                    switch (j)
                    {
                        ...
                        case 1:
                            TriggerOutput2.Set();
                            TriggerOutput2.Unset();

                            break;

                        case 2:
                            TriggerOutput3.Set();
                            TriggerOutput3.Unset();

                            break;

                        case 3:
                            TriggerOutput4.Set();
                            TriggerOutput4.Unset();
            ...
            var registersMap = new Dictionary<long, DoubleWordRegister>
            {
                {(long)Registers.Control1, new DoubleWordRegister(this)
                    ...
                    .WithFlag(3,
                        writeCallback: (_, val) => Mode = val ? WorkMode.OneShot : WorkMode.Periodic,
                        valueProviderCallback: _ => Mode == WorkMode.OneShot, name: "One-pulse mode (OPM)")
                    .WithFlag(4,
                        writeCallback: (_, val) => Direction = val ? Direction.Descending : Direction.Ascending,
                    ...
                    .WithValueField(8, 2, name: "Clock Division (CKD)")
                ...
                {(long)Registers.Control2, new DoubleWordRegister(this)
                    .WithFlag(0, name: "CCPC")
                    .WithReservedBits(1, 1)
                    .WithFlag(2, name: "CCUS")
                    .WithFlag(3, name: "CCDS")
                    .WithValueField(4, 2, name: "MMS")
                    .WithFlag(7, name: "TI1S")
                    .WithFlag(8, name: "OIS1")
                    .WithFlag(9, name: "OIS1N")
                    .WithFlag(10, name: "OIS2")
                    .WithFlag(11, name: "OIS2N")
                    .WithFlag(12, name: "OIS3")
                    .WithFlag(13, name: "OIS3N")
                    .WithFlag(14, name: "OIS4")
                    .WithReservedBits(15, 17)
                },
                {(long)Registers.SlaveModeControl, new DoubleWordRegister(this)
                    .WithValueField(0, 3, name: "SMS")
                    .WithFlag(3, name: "OCCS")
                    .WithValueField(4, 3, name: "TS")
                    .WithFlag(7, name: "MSM")
                    .WithValueField(8, 4, name: "ETF")
                    .WithValueField(12, 2, name: "ETPS")
                    .WithFlag(14, name: "ECE")
                    .WithFlag(15, name: "ETP")
                ...
                {(long)Registers.DmaOrInterruptEnable, new DoubleWordRegister(this)
                    ...
                    .WithFlag(1, valueProviderCallback: _ => ccInterruptEnable[0],
                        writeCallback: (_, val) => WriteCaptureCompareInterruptEnable(0, val), name: "Capture/Compare 1 interrupt enable (CC1IE)")
                    .WithFlag(2, valueProviderCallback: _ => ccInterruptEnable[1],
                        writeCallback: (_, val) => WriteCaptureCompareInterruptEnable(1, val), name: "Capture/Compare 2 interrupt enable (CC2IE)")
                    .WithFlag(3, valueProviderCallback: _ => ccInterruptEnable[2],
                        writeCallback: (_, val) => WriteCaptureCompareInterruptEnable(2, val), name: "Capture/Compare 3 interrupt enable (CC3IE)")
                    .WithFlag(4, valueProviderCallback: _ => ccInterruptEnable[3],
                        writeCallback: (_, val) => WriteCaptureCompareInterruptEnable(3, val), name: "Capture/Compare 4 interrupt enable (CC4IE)")
                    .WithReservedBits(5, 1)
                    .WithFlag(6, name: "Trigger interrupt enable (TIE)")
                    .WithReservedBits(7, 1)
                    .WithFlag(8, name: "Update DMA request enable (UDE)")
                    ...
                    .WithFlag(14, name: "Trigger DMA request enable (TDE)")
                    .WithReservedBits(15, 17)
                ...
                {(long)Registers.Status, new DoubleWordRegister(this)
                    ...
                    .WithFlag(1, FieldMode.Read | FieldMode.WriteZeroToClear,
                        writeCallback: (_, val) => ClaimCaptureCompareInterrupt(0, val),
                        valueProviderCallback: _ => ccInterruptFlag[0], name: "Capture/Compare 1 interrupt flag (CC1IF)")
                    .WithFlag(2, FieldMode.Read | FieldMode.WriteZeroToClear,
                        writeCallback: (_, val) => ClaimCaptureCompareInterrupt(1, val),
                        valueProviderCallback: _ => ccInterruptFlag[1], name: "Capture/Compare 2 interrupt flag (CC2IF)")
                    .WithFlag(3, FieldMode.Read | FieldMode.WriteZeroToClear,
                        writeCallback: (_, val) => ClaimCaptureCompareInterrupt(2, val),
                        valueProviderCallback: _ => ccInterruptFlag[2], name: "Capture/Compare 3 interrupt flag (CC3IF)")
                    .WithFlag(4, FieldMode.Read | FieldMode.WriteZeroToClear,
                        writeCallback: (_, val) => ClaimCaptureCompareInterrupt(3, val),
                        valueProviderCallback: _ => ccInterruptFlag[3], name: "Capture/Compare 4 interrupt flag (CC4IF)")
                    ...
                    .WithValueField(6, 1, FieldMode.WriteZeroToClear,
                        writeCallback: (_, __) => {}, name: "Trigger interrupt flag (TIE)")
                    .WithFlag(7, name: "Reserved2")
                    .WithFlag(8, name: "Reserved3")
                    .WithValueField(9, 1, FieldMode.WriteZeroToClear,
                        writeCallback: (_, __) => {}, name: "Capture/Compare 1 overcapture flag (CC1OF)")
                    .WithValueField(10, 1, FieldMode.WriteZeroToClear,
                        writeCallback: (_, __) => {}, name: "Capture/Compare 2 overcapture flag (CC2OF)")
                    .WithValueField(11, 1, FieldMode.WriteZeroToClear,
                        writeCallback: (_, __) => {}, name: "Capture/Compare 3 overcapture flag (CC3OF)")
                    .WithValueField(12, 1, FieldMode.WriteZeroToClear,
                        writeCallback: (_, __) => {}, name: "Capture/Compare 4 overcapture flag (CC4OF)")
                ...
                {(long)Registers.EventGeneration, new DoubleWordRegister(this)
                    ...
                    .WithFlag(1, name: "Capture/compare 1 generation (CC1G)")
                    .WithFlag(2, name: "Capture/compare 2 generation (CC2G)")
                    .WithFlag(3, name: "Capture/compare 3 generation (CC3G)")
                    .WithFlag(4, name: "Capture/compare 4 generation (CC4G)")
                    .WithFlag(5, name: "Capture/compare update generation (COMG)")
                    .WithFlag(6, name: "Trigger generation (TG)")
                ...
                {(long)Registers.CaptureOrCompareMode1, new DoubleWordRegister(this)
                    ...
                    .WithEnumField<DoubleWordRegister, CaptureCompareSelection>(0, 2,
                        writeCallback: (_, val) => WriteCaptureCompareSelection(0, val), name: "CC1S")
                    // Input mode:
                        // "IC1PSC", 2, 2
                        // "IC1F", 4, 4
                    .WithFlag(2, name: "OC1FE")
                    .WithFlag(3, name: "OC1PE")
                    .WithEnumField(4, 3, out outputCompareModes[0],
                        writeCallback: (_, val) => WriteOutputCompareMode(0, val), name: "OC1M")
                    .WithFlag(7, name: "OC1CE")
                    .WithEnumField<DoubleWordRegister, CaptureCompareSelection>(8, 2,
                        writeCallback: (_, val) => WriteCaptureCompareSelection(1, val), name: "CC2S")
                    .WithFlag(10, name: "OC2FE")
                    .WithFlag(11, name: "OC2PE")
                    .WithEnumField(12, 3, out outputCompareModes[1],
                        writeCallback: (_, val) => WriteOutputCompareMode(1, val), name: "OC2M")
                    .WithFlag(15, name: "OC2CE")
                    // Input mode:
                        // "IC2PSC", 10, 2
                        // "IC2F", 12, 4
                    .WithReservedBits(16, 16)
                ...
                {(long)Registers.CaptureOrCompareMode2, new DoubleWordRegister(this)
                    ...
                    // Only fields for output compare mode are defined
                    .WithEnumField<DoubleWordRegister, CaptureCompareSelection>(0, 2,
                        writeCallback: (_, val) => WriteCaptureCompareSelection(2, val), name: "CC3S")
                    .WithFlag(2, name: "OC3FE")
                    .WithFlag(3, name: "OC3PE")
                    .WithEnumField(4, 3, out outputCompareModes[2], writeCallback: (_, val) => WriteOutputCompareMode(2, val), name: "OC3M")
                    .WithFlag(7, name: "OC3CE")
                    // Input mode:
                        // "IC3PSC", 2, 2
                        // "IC3F", 4, 4
                    .WithEnumField<DoubleWordRegister, CaptureCompareSelection>(8, 2,
                        writeCallback: (_, val) => WriteCaptureCompareSelection(3, val), name: "CC4S")
                    .WithFlag(10, name: "OC4FE")
                    .WithFlag(11, name: "OC4PE")
                    .WithEnumField(12, 3, out outputCompareModes[3], writeCallback: (_, val) => WriteOutputCompareMode(3, val), name: "OC4M")
                    .WithFlag(15, name: "OC4CE")
                    // Input mode:
                        // "IC4PSC", 10, 2
                        // "IC4F", 12, 4
                    .WithReservedBits(16, 16)
                ...
                {(long)Registers.CaptureOrCompareEnable, new DoubleWordRegister(this)
                    .WithFlag(0, valueProviderCallback: _ => ccOutputEnable[0],
                        writeCallback: (_, val) => WriteCaptureCompareOutputEnable(0, val), name: "Capture/Compare 1 enable (CC1E)")
                    .WithFlag(1, name: "CC1P")
                    .WithFlag(2, name: "CC1NE")
                    .WithFlag(3, name: "CC1NP")
                    .WithFlag(4, valueProviderCallback: _ => ccOutputEnable[1],
                        writeCallback: (_, val) => WriteCaptureCompareOutputEnable(1, val), name: "Capture/Compare 2 enable (CC2E)")
                    .WithFlag(5, name: "CC2P")
                    .WithFlag(6, name: "CC2NE")
                    .WithFlag(7, name: "CC2NP")
                    .WithFlag(8, valueProviderCallback: _ => ccOutputEnable[2],
                        writeCallback: (_, val) => WriteCaptureCompareOutputEnable(2, val), name: "Capture/Compare 3 enable (CC3E)")
                    .WithFlag(9, name: "CC3P")
                    .WithFlag(10, name: "CC3NE")
                    .WithFlag(11, name: "CC3NP")
                    .WithFlag(12, valueProviderCallback: _ => ccOutputEnable[3],
                        writeCallback: (_, val) => WriteCaptureCompareOutputEnable(3, val), name: "Capture/Compare 4 enable (CC4E)")
                ...
                {(long)Registers.RepetitionCounter, new DoubleWordRegister(this)
                    .WithValueField(0, 8, out repetitionCounter, name: "Repetition counter (RCR)")
                    .WithReservedBits(8, 24)
                },
                {(long)Registers.BreakAndDeadTime, new DoubleWordRegister(this)
                    .WithValueField(0, 8, name: "Dead-time generator setup (DTG)")
                    .WithValueField(8, 2, name: "Lock configuration (LOCK)")
                    .WithFlag(10, name: "Off-state selection for Idle mode (OSSI)")
                    .WithFlag(11, name: "Off-state selection for Run mode (OSSR)")
                    .WithFlag(12, name: "Break enable (BKE)")
                    .WithFlag(13, name: "Break polarity (BKP)")
                    .WithFlag(14, name: "Automatic output enable (AOE)")
                    .WithFlag(15, name: "Main output enable (MOE)")
                    .WithReservedBits(16, 16)
                },
                {(long)Registers.DmaControl, new DoubleWordRegister(this)
                    .WithValueField(0, 5, name: "DMA base address (DBA)")
                    .WithReservedBits(5, 3)
                    .WithValueField(8, 5, name: "DMA burst length (DBL)")
                    .WithReservedBits(13, 19)
                },
                {(long)Registers.DmaAddressForFullTransfer, new DoubleWordRegister(this)
                    .WithTag("DMA address for full transfer (RCR)", 0, 32)
                },
            };
            ...
            for (var i = 0; i < NumberOfCCChannels; ++i)
            {
                ...
                registersMap.Add((long)Registers.CaptureOrCompare1 + (j * 0x4), new DoubleWordRegister(this)
                    .WithValueField(0, timerCounterLengthInBits,
                        valueProviderCallback: _ => (uint)ccTimers[j].Limit,
                        writeCallback: (_, val) =>
                        {
                            if (val == 0)
                            {
        ...
        public GPIO TriggerOutput0 { get; private set; }
        public GPIO TriggerOutput1 { get; private set; }
        public GPIO TriggerOutput2 { get; private set; }
        public GPIO TriggerOutput3 { get; private set; }
        public GPIO TriggerOutput4 { get; private set; }
